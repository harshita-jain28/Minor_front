...
const NewEntry: React.FC<EntryProps> = ({ username, divstyle, setUrl, imgUrl, setStyle, setEntry, selDate, setTitle,title, setDiary, diary, setEntries, setImg, diaId, setId }) => {
